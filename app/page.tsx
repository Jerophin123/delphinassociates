...
export const metadata: Metadata = {
  title: {
    absolute: "Delphin Associates | Civil Engineers & Contractors | Chennai, Tamil Nadu",
  },
  description:
  ...
  openGraph: {
    title: "Delphin Associates | Civil Engineers & Contractors | Chennai, Tamil Nadu",
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Delphin Associates - Civil Engineers & Contractors",
      },
    ],
  },
  alternates: {
