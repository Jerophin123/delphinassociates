...
export default function ServicesCTA() {
  ...
  return (
    <section className="relative mt-8 sm:mt-16 md:mt-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className={`relative overflow-hidden rounded-[2.5rem] ${tier === 'very-low' ? 'bg-white' : 'bg-gradient-to-br from-white/95 to-gray-50/95'} border ${isHigh ? 'border-accent/20' : 'border-gray-100'} shadow-[0_10px_40px_-10px_rgba(0,0,0,0.05)] p-12 sm:p-16 md:p-20`}>
