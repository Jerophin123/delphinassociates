...
export default function CompanyHistory() {
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-3xl border border-accent/15 bg-gradient-to-b from-white to-gray-50 p-6 sm:p-8">
        ...
        <div className="relative">
          <motion.div variants={itemVariants} className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-accent/20 bg-accent/10">
          ...
          <motion.h2 variants={itemVariants} className="mt-4 text-2xl sm:text-3xl font-bold font-display tracking-[0.01em] bg-gradient-to-r from-accent via-accent-light to-accent bg-clip-text text-transparent">
            Our History
          </motion.h2>

          <div className="mt-5 grid lg:grid-cols-12 gap-8 items-start">
            <motion.div variants={itemVariants} className="lg:col-span-4">
              <div className="rounded-3xl border border-gray-200 bg-white/70 backdrop-blur-sm p-5 hover:shadow-md transition-shadow">
