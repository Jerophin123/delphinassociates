...
export default function ContactInfo() {
  return (
    <motion.div
      ...
      className="bg-gradient-to-br from-gray-50 to-white rounded-lg shadow-[0_8px_16px_-4px_rgba(0,0,0,0.12),0_4px_8px_-2px_rgba(0,0,0,0.08),0_2px_4px_-1px_rgba(0,0,0,0.06)] p-4 sm:p-6 md:p-8 hover:shadow-[0_24px_48px_-8px_rgba(0,0,0,0.22),0_12px_24px_-6px_rgba(0,0,0,0.14),0_6px_12px_-3px_rgba(0,0,0,0.1)] transition-all duration-300 hover:-translate-y-2 hover:scale-[1.01]"
    >
