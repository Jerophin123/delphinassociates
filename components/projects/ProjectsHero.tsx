        ...
        >
          ...
          <div className="relative z-10 grid lg:grid-cols-[1fr_minmax(auto,450px)] gap-12 lg:gap-16 items-center">
            ...
            <div className="text-left">
              ...
              >
                {isHigh ? (
                  ...
                  <span className="text-primary-dark">Our Projects</span>
                )}
              </motion.h1>
            ...
            >
              ...
              {isHigh && (
                <div className="absolute inset-0 h-full w-full bg-gradient-to-r from-transparent via-accent/5 to-transparent -translate-x-full hover:animate-[shimmer_2s_infinite] pointer-events-none z-[1]" />
              )}
