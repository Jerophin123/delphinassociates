  ...
  return (
    <div>
      <div className="mb-8 sm:mb-10 md:mb-12">
        <div className="rounded-3xl border border-accent/15 bg-white/80 backdrop-blur-sm shadow-sm px-3 py-3 sm:px-4 sm:py-4">
              ...
              {categoryConfig.map((category, index) => {
                ...
                return (
                  <motion.button
                    ...
                    className={`group relative px-4 sm:px-5 py-2 rounded-2xl font-semibold text-xs sm:text-sm transition-all duration-300 flex items-center gap-2 ${
                      isActive
              ...
              return (
                ...
                >
                  <Link
                    ...
                    className="group block h-full rounded-3xl bg-white border border-gray-100 overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300 focus:outline-none focus:ring-2 focus:ring-accent/40"
                  >
                    <div className="relative aspect-[4/3] bg-gradient-to-br from-accent/20 to-primary/10 overflow-hidden">
                      ...
                      <div className="absolute top-4 left-4 z-10">
                        <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/90 backdrop-blur border border-gray-200 text-xs font-semibold text-gray-900">
                      ...
                      <div className="absolute top-4 right-4 z-10">
                        <span className="inline-flex items-center px-2.5 py-1 rounded-full bg-white/90 backdrop-blur border border-gray-200 text-xs font-semibold text-gray-900">
